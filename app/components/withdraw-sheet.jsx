        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            <div className="space-y-2">
              ...
              {parseFloat(amount) > 0 && (
                <div className="mt-2 p-3 bg-muted/30 rounded-md space-y-2">
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground mt-1">
                    ...
                    <span>Estimated processing time: {withdrawalInfo.processingTime}h</span>
                  </div>
                </div>
              )}
              ...
              {parseFloat(amount) > 0 && parseFloat(amount) < withdrawalInfo.minimumWithdrawal && (
                <p className="text-sm text-amber-600 flex items-center mt-1">
                  <AlertCircle className="h-4 w-4 mr-1" />
                  Minimum withdrawal amount is {formatCurrency(withdrawalInfo.minimumWithdrawal)}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {fetchingSettings ? (
                ...
                <div className="border rounded-md p-4 text-center">
                  <p className="text-sm text-muted-foreground mb-2">No payout methods found</p>
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => window.location.href = '/dashboard/settings/payout'}
                  >
                    Add Payout Method
                  </Button>
                </div>
