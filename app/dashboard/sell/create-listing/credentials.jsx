    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Enter the account credentials that will be securely transferred to the buyer after purchase.
        </p>
        <div className="bg-muted/30 border border-yellow-200 dark:border-yellow-900/50 rounded-lg p-4 flex gap-2 items-start">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/60"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Key or Serial Number (Optional)</label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Credential Images (Optional)</label>
        ...
        <TabsContent value="recovery" className="space-y-4 mt-4">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-sm font-medium">Recovery Account Type</label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Recovery Phone</label>
                <input
                  type="text"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Security Questions & Answers</label>
              <textarea
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Recovery Images</label>
              <p className="text-xs text-muted-foreground">Upload recovery QR codes, backup codes, or screenshots (max 5MB each)</p>
