...
export const registerPartials = async () => {
  ...
  try {
    ...
    console.log('Email template partials registered successfully');
  } catch (error) {
    console.error('Error registering partials:', error);
    console.error('Partials directory was:', partialsDir);
...
// Also trigger registering partials when the module loads
registerPartials().catch(e => console.error('Error initializing email partials:', e)); 